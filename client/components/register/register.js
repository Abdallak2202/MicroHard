...
//         <h2 class="text-center text-4xl font-medium">Registrate</h2>
...
//         <button class="transform rounded-sm bg-zinc-600 py-2 font-bold duration-300 p-2 mt-4 hover:bg-zinc-700" type="submit" >Registrarse</button>
