...
import Table from '../../../components/clientes/filtroClientes';
 ...
 export const MyPage = () => {
  ...
  <div class=" bg-gradient-to-r from-gray-200 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      ...
      <svg class="w-12 h-12" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512H418.3c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304H178.3z"/></svg>        
          <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">Leanne Graham</h5>
          <span class="text-sm text-gray-800 dark:text-gray-600">Local comercial</span>
          <div class="flex mt-4 space-x-3 md:mt-6">
              <a href="#" class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-gray-700 rounded-lg hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 dark:bg-graye-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800">Calle 1234</a>
              <a href="#" class=" inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-gray-700 rounded-lg hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 dark:bg-graye-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800">Sincere@april.biz</a>
              <a href="#"  class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-gray-700 rounded-lg hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 dark:bg-graye-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800">3442-8764582</a>
              <a href="#"  class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-gray-700 rounded-lg hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 dark:bg-graye-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800">20-36549015-4</a>
          ...
          <table class="w-full text-sm text-left text-gray-100 dark:text-gray-100">
              ...
              <tbody>
                  ...
                  <tr class="bg-gray-600 border-b border-blue-400 hover:bg-gray-500">
                      ...
                      <td class="px-6 py-4">
                          <a href="#" class="font-medium text-white hover:underline">$30.500</a>
                      </td>
                  </tr>
                  <tr class="bg-gray-600 border-b border-blue-400 hover:bg-gray-500">
                      <th scope="row" class="px-6 py-4 font-medium text-gray-50 whitespace-nowrap dark:text-gray-100">
                      ...
                      <td class="px-6 py-4">
                          <a href="#" class="font-medium text-white hover:underline">$31.400</a>
                      </td>
                  </tr>
                  <tr class="bg-gray-600 border-b border-blue-400 hover:bg-gray-500">
                      <th scope="row" class="px-6 py-4 font-medium text-gray-50 whitespace-nowrap dark:text-gray-100">
                      ...
                      <td class="px-6 py-4">
                          <a href="#" class="font-medium text-white hover:underline">$96.800</a>
                      </td>
                  </tr>
                  <tr class="bg-gray-600 border-b border-gray-400 hover:bg-gray-500">
                      <th scope="row" class="px-6 py-4 font-medium text-gray-50 whitespace-nowrap dark:text-gray-100">
                          Presupuesto 5
                      </th>
                      <td class="px-6 py-4">
                      ...
                      <td class="px-6 py-4">
                          <a href="#" class="font-medium text-white hover:underline">$117.370</a>
                      </td>
                  </tr>
              </tbody>
          </table>
